...
//   {
//     isAuthenticated ? (
//       <button onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })} style={{ backgroundColor: '#498070', color: '#fff', padding: '10px 20px', border: 'none', borderRadius: '5px', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
//         Log Out
//       </button>
//     ) : (
...
// Run in terminal : npm install @auth0/auth0-react